<div>
    <div class="flex justify-between my-2">
        ...
        <button wire:click="$emit('openModal', 'department-form')" class="btn btn-primary">Add Department +</button>
    </div>
        ...
        <table class="table text-center border mt-4 intro-y">
            ...
            <tbody>
                ...
                <tr class="{{ $loop->even ? 'bg-gray-200' : '' }}">
                    ...
                    <td>
                        <a wire:click.prevent="$emit('openModal', 'department-edit', {{ json_encode(['dp_id'=> $department->id]) }})"
