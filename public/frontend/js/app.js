...
$(function () {
    let promoModal = $("#promoModal");

    // PROMO MODAL FOR Front-End INDEX PAGE
    if (promoModal.length > 0) {
        let promoModalCLoseBtn = $("#promoModal .promoModalClose");
        promoModalCLoseBtn.click(function () {
            promoModal.fadeOut(200);
        });
    }
    // MENU FIXED
